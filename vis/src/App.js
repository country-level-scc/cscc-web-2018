        ...
        {page === 'winners' && (
          <div>
            ...
            <p className="caption">
              ...
              shares of 2013 CO2 emissions. CSCC is the median estimate with
              growth adjusted discounting for SSP2/RCP6.0, BHM- SR reference
              specification (short run, pooled countries). Bubble size
              corresponds to the country’s GDP (log(USD)) and the color
              indicates per-capita CSCC ($/MtCO2/person). Diagonal lines show
              the ratio of global SCC share to emissions share. Ratios greater
              than 1:1 indicate that a country’s share of global SSC exceeds it
              share of global emission. Grey box in left panel indicates the
              bounds of the detail shown in right panel.
            </p>
          </div>
        )}
